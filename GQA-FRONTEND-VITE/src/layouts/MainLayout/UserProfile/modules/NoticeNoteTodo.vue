...
import NoticeNoteTodoDetail from './NoticeNoteTodoDetail.vue'
...
const { pagination, pageOptions, GqaDictShow, loading, tableData, recordDetailDialog, showAddForm, showEditForm, onRequest, getTableData, handleFinish, handleDelete } = useTableData(url)
