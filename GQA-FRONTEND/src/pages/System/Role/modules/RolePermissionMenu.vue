<template>
    <div class="items-center column">
        <div class="justify-between row" style="width: 100%">
            <q-btn color="negative" :disable="row.roleCode === 'super-admin'" @click="handleClear">{{ $t('PageSystemRolePermissionMenuClearAll') }}</q-btn>
            <q-btn color="negative" :disable="row.roleCode === 'super-admin'" @click="handleAll">{{ $t('PageSystemRolePermissionMenuSelectAll') }}</q-btn>
            <q-btn color="primary" :disable="row.roleCode === 'super-admin'" @click="handleRoleMenu">{{ $t('PageSystemRolePermissionMenuSaveRights') }}</q-btn>
        </div>
