<template>
    <q-page padding>
        ...
        <div class="row q-gutter-md items-center" style="margin-bottom: 10px">
            <q-input style="width: 20%" v-model="queryParams.gqaOption" label="后台配置名" />
        ...
        <q-table row-key="id" separator="cell" :rows="tableData" :columns="columns" v-model:pagination="pagination"
            ...
            <template v-slot:top="props">
                <q-btn color="primary" @click="showAddForm()" label="新增后台配置" />
                <q-space />
    ...
    data() {
        return {
            ...
            columns: [
                ...
                { name: 'gqaOption', align: 'center', label: '后台配置名', field: 'gqaOption' },
                { name: 'remark', align: 'center', label: '描述', field: 'remark' },
                { name: 'default', align: 'center', label: '默认后台配置', field: 'default' },
                { name: 'custom', align: 'center', label: '自定义后台配置', field: 'custom' },
