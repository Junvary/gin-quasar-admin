...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                { name: 'sort', align: 'center', label: this.$t('PageSystemUserTableColumnSort'), field: 'sort' },
                { name: 'avatar', align: 'center', label: this.$t('PageSystemUserTableColumnAvatar'), field: 'avatar' },
                { name: 'username', align: 'center', label: this.$t('PageSystemUserTableColumnUsername'), field: 'username' },
                { name: 'nickname', align: 'center', label: this.$t('PageSystemUserTableColumnNickname'), field: 'nickname' },
                { name: 'realName', align: 'center', label: this.$t('PageSystemUserTableColumnRealname'), field: 'realName' },
                { name: 'gender', align: 'center', label: this.$t('PageSystemUserTableColumnGender'), field: 'gender' },
                { name: 'mobile', align: 'center', label: this.$t('PageSystemUserTableColumnMobile'), field: 'mobile' },
                // { name: 'email', align: 'center', label: '邮箱', field: 'email' },
                { name: 'dept', align: 'center', label: this.$t('PageSystemUserTableColumnDept'), field: 'dept' },
                { name: 'status', align: 'center', label: this.$t('PageSystemUserTableColumnStatus'), field: 'status' },
                { name: 'stable', align: 'center', label: this.$t('PageSystemUserTableColumnStable'), field: 'stable' },
                { name: 'actions', align: 'center', label: this.$t('PageSystemUserTableColumnActions'), field: 'actions' },
            ],
        }
    },
    created() {
