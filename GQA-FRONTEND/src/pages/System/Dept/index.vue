        ...
        <q-splitter v-model="splitterModel">
            <template v-slot:before>
                <div class="q-pa-md column">
                    <div class="col">
                        <q-btn :label="$t('PageSystemDeptBtnAdd')" color="primary" @click="showAddForm" />
                    </div>
                    <q-separator />
                    <q-tree :nodes="menuTree" default-expand-all node-key="id" label-key="name" selected-color="primary"
                        ...
                        <template v-slot:default-header="prop">
                            ...
                            <q-btn :label="$t('PageSystemDeptBtnDelete')" style="float-right" color="negative" dense
...
export default {
    ...
    methods: {
        ...
        handleDelete(row) {
            this.$q
                .dialog({
                    title: $t('PageSystemDeptDeleteTitle'),
                    message: $t('PageSystemDeptDeleteMessage'),
                    cancel: true,
                    persistent: true,
                })
                .onOk(async () => {
