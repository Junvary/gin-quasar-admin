...
var sysDeptData = []system.SysDept{
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 1, Status: "on", Sort: 1, Desc: "这是Gin-Quasar-Admin部门", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
		ParentId: 0, DeptCode: "gin-quasar-admin", DeptName: "Gin-Quasar-Admin部门", OwnerId: 1,
	},

	// 子级内容：
	{GqaModel: global.GqaModel{Status: "on", Sort: 1, Desc: "这是Gin部门", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
		ParentId: 1, DeptCode: "gin", DeptName: "Gin部门", OwnerId: 1,
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 2, Desc: "这是Quasar部门", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
