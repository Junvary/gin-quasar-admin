...
var sysConfigFrontendData = []system.SysConfigFrontend{
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1001, Remark: "首页大图", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaBannerImage", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1002, Remark: "网站主标题", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaMainTitle", Default: "Gin-Quasar-Admin",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1003, Remark: "网站次标题", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaSubTitle", Default: "Gin-Quasar-Admin",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1004, Remark: "网站描述", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaDescribe", Default: "Lorem ipsum dolor sit amet consectetur adipisicing elit",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1005, Remark: "登录页插件", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaPluginLoginLayout", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1006, Remark: "网站Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaWebLogo", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1007, Remark: "标签页Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaHeaderLogo", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1008, Remark: "显示仓库入口", CreatedAt: time.Now(), CreatedBy: "admin"},
