...
var sysConfigFrontendData = []system.SysConfigFrontend{
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 4, Remark: "登录页插件", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaPluginLoginLayout", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 5, Remark: "网站Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaWebLogo", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 6, Remark: "标签页Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "gqaHeaderLogo", Default: "",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 67, Remark: "显示仓库入口", CreatedAt: time.Now(), CreatedBy: "admin"},
...
func (s *sysConfigFrontend) LoadData() error {
	return global.GqaDb.Transaction(func(tx *gorm.DB) error {
		...
		if count != 0 {
			...
			global.GqaLog.Error("[Gin-Quasar-Admin] --> sys_config_frontend 表的初始数据已存在，跳过初始化数据！", zap.Any("数据量", count))
			return nil
		}
		...
		global.GqaLog.Error("[Gin-Quasar-Admin] --> sys_config_frontend 表初始数据成功！")
		return nil
	})
}
