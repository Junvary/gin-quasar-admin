...
var sysMenuData = []system.SysMenu{
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 1, Status: "on", Sort: 1, Desc: "这是仪表盘", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 2, Status: "on", Sort: 2, Desc: "这是系统管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
		ParentId: 0, Name: "system", Path: "", Component: "",
		Hidden: false, KeepAlive: false, Title: "系统管理", Icon: "settings", IsLink: false,
	},
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 3, Status: "on", Sort: 3, Desc: "这是系统示例", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
		ParentId: 0, Name: "example", Path: "", Component: "",
		Hidden: false, KeepAlive: false, Title: "系统示例", Icon: "star", IsLink: false,
	},

	// 子级内容：
	{GqaModel: global.GqaModel{Status: "on", Sort: 1, Desc: "这是部门管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 2, Desc: "这是用户管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 3, Desc: "这是角色管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 4, Desc: "这是菜单管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 5, Desc: "这是字典管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 6, Desc: "这是日志管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 1, Desc: "这是图标合集", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
