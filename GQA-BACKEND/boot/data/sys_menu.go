...
var sysMenuData = []system.SysMenu{
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 6, Remark: "这是配置管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 7, Remark: "这是日志管理", CreateAt: time.Now(), CreateBy: "admin", UpdateAt: time.Now()},
