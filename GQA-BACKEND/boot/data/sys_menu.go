...
var sysMenuData = []system.SysMenu{
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 1, Stable: "yes", Status: "on", Sort: 1, Remark: "这是仪表盘", CreatedAt: time.Now(), CreatedBy: "admin"},
		ParentId: 0, Name: "dashboard", Path: "/dashboard", Component: "/Dashboard/index",
		Title: "仪表盘", Icon: "home", Hidden: "no", KeepAlive: "no", IsLink: "no",
	},
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 2, Stable: "yes", Status: "on", Sort: 2, Remark: "这是系统管理", CreatedAt: time.Now(), CreatedBy: "admin"},
		ParentId: 0, Name: "system", Path: "", Component: "",
		Title: "系统管理", Icon: "settings", Hidden: "no", KeepAlive: "no", IsLink: "no",
	},
	// 父级设置ID
	{GqaModel: global.GqaModel{Id: 3, Stable: "yes", Status: "on", Sort: 3, Remark: "这是系统示例", CreatedAt: time.Now(), CreatedBy: "admin"},
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 6, Remark: "这是配置管理", CreatedAt: time.Now(), CreatedBy: "admin"},
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 7, Remark: "这是日志管理", CreatedAt: time.Now(), CreatedBy: "admin"},
