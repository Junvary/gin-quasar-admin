...
var sysConfigBackendData = []system.SysConfigBackend{
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1008, Remark: "Jwt过期时间", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "jwtExpiresAt", Default: "604800",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1009, Remark: "头像最大上传（M）", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "avatarMaxSize", Default: "3",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1010, Remark: "头像允许后缀", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "avatarExt", Default: ".png,.jpg",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1011, Remark: "文件最大上传（M）", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "fileMaxSize", Default: "10",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1012, Remark: "文件允许后缀", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "fileExt", Default: ".png,.jpg,.docx,.xlsx,.txt,.doc,.xls",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1013, Remark: "网站Logo最大上传（M）", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "webLogoMaxSize", Default: "2",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1014, Remark: "网站Logo允许后缀", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "webLogoExt", Default: ".ico,.png,.jpg",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1015, Remark: "标签页Logo最大上传（M）", CreatedAt: time.Now(), CreatedBy: "admin"},
		GqaOption: "headerLogoMaxSize", Default: "1",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1016, Remark: "标签页Logo允许后缀", CreatedAt: time.Now(), CreatedBy: "admin"},
