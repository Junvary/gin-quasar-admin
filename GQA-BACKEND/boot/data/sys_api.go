...
var sysApiData = []system.SysApi{
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1021, Remark: "获取菜单列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "menu", ApiPath: "/menu/menu-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1022, Remark: "编辑菜单信息", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "menu", ApiPath: "/menu/menu-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1023, Remark: "新增菜单", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "menu", ApiPath: "/menu/menu-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1024, Remark: "删除菜单", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "menu", ApiPath: "/menu/menu-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1025, Remark: "根据ID查找菜单", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "menu", ApiPath: "/menu/menu-id", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1026, Remark: "获取部门列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1027, Remark: "编辑部门信息", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1028, Remark: "新增部门", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1029, Remark: "删除部门", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1030, Remark: "根据ID查找部门", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-id", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1031, Remark: "根据部门查找用户", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-user", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1032, Remark: "从部门中移除某个用户", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-user-remove", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1033, Remark: "添加用户到某个部门", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dept", ApiPath: "/dept/dept-user-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1034, Remark: "获取根字典列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dict", ApiPath: "/dict/dict-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1035, Remark: "编辑字典信息", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dict", ApiPath: "/dict/dict-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1036, Remark: "新增字典", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dict", ApiPath: "/dict/dict-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1037, Remark: "删除字典", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dict", ApiPath: "/dict/dict-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1038, Remark: "根据ID查找字典", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "dict", ApiPath: "/dict/dict-id", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1039, Remark: "获取api列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "api", ApiPath: "/api/api-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1040, Remark: "编辑api信息", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "api", ApiPath: "/api/api-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1041, Remark: "新增api", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "api", ApiPath: "/api/api-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1042, Remark: "删除api", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "api", ApiPath: "/api/api-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1043, Remark: "上传头像", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "upload", ApiPath: "/upload/avatar", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1044, Remark: "上传文件", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "upload", ApiPath: "/upload/file", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1045, Remark: "上传网站Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "upload", ApiPath: "/upload/web-logo", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1046, Remark: "上传标签页Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "upload", ApiPath: "/upload/header-logo", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1047, Remark: "获取后台配置列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1048, Remark: "编辑后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1049, Remark: "新增后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1050, Remark: "删除后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1051, Remark: "获取前台配置列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1052, Remark: "编辑前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1053, Remark: "新增前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 1054, Remark: "删除前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
