...
var sysApiData = []system.SysApi{
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 39, Remark: "上传标签页Logo", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "upload", ApiPath: "/upload/header-logo", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 40, Remark: "获取后台配置列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 41, Remark: "编辑后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 42, Remark: "新增后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 43, Remark: "删除后台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-backend", ApiPath: "/config-backend/config-backend-delete", ApiMethod: "DELETE",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 44, Remark: "获取前台配置列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-list", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 45, Remark: "编辑前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-edit", ApiMethod: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 46, Remark: "新增前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		ApiGroup: "config-frontend", ApiPath: "/config-frontend/config-frontend-add", ApiMethod: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 47, Remark: "删除前台配置", CreatedAt: time.Now(), CreatedBy: "admin"},
