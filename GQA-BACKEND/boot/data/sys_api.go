...
var sysApiData = []system.SysApi{
	...
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 38, Remark: "获取配置列表", CreatedAt: time.Now(), CreatedBy: "admin"},
		Group: "config", Path: "/config/config-list", Method: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 39, Remark: "编辑配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		Group: "config", Path: "/config/config-edit", Method: "PUT",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 40, Remark: "新增配置", CreatedAt: time.Now(), CreatedBy: "admin"},
		Group: "config", Path: "/config/config-add", Method: "POST",
	},
	{GqaModel: global.GqaModel{Stable: "yes", Status: "on", Sort: 41, Remark: "删除配置", CreatedAt: time.Now(), CreatedBy: "admin"},
