...
func (s *ServiceGenPlugin) GenPlugin(genPluginStruct *system.SysGenPlugin) (err error) {
	dataList, fileList, makeDirList, err := s.PrepareData(genPluginStruct)
	if err != nil {
		return err
	}
	if err = utils.CreateDir(makeDirList...); err != nil {
		return err
	}
	// 生成文件
...
func (s *ServiceGenPlugin) PrepareData(genPluginStruct *system.SysGenPlugin) (dataList []tplData, fileList []string, makeDirList []string, err error) {
