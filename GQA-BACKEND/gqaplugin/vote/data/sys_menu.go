...
var sysMenuData = []system.SysMenu{
	...
	{GqaModel: global.GqaModel{Status: "on", Sort: 1, Remark: "投票", CreatedAt: time.Now(), CreatedBy: "admin"},
		Name: "plugin-vote-vote", ParentCode: "GqaPluginVote", Title: "投票", Icon: "how_to_vote",
		Path: "/plugin-vote/vote/vote", Component: "/Plugin/Vote/Vote/index",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 2, Remark: "抽取投票人", CreatedAt: time.Now(), CreatedBy: "admin"},
		Name: "plugin-vote-voter-random", ParentCode: "GqaPluginVote", Title: "抽取投票人", Icon: "refresh",
		Path: "/plugin-vote/vote/voter-random", Component: "/Plugin/Vote/VoterRandom/index",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 3, Remark: "固定投票人", CreatedAt: time.Now(), CreatedBy: "admin"},
		Name: "plugin-vote-voter", ParentCode: "GqaPluginVote", Title: "固定投票人", Icon: "emoji_people",
		Path: "/plugin-vote/vote/voter", Component: "/Plugin/Vote/Voter/index",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 4, Remark: "候选人", CreatedAt: time.Now(), CreatedBy: "admin"},
		Name: "plugin-vote-candidate", ParentCode: "GqaPluginVote", Title: "候选人", Icon: "people",
		Path: "/plugin-vote/vote/candidate", Component: "/Plugin/Vote/Candidate/index",
	},
	{GqaModel: global.GqaModel{Status: "on", Sort: 5, Remark: "投票结果", CreatedAt: time.Now(), CreatedBy: "admin"},
		Name: "plugin-vote-score-result", ParentCode: "GqaPluginVote", Title: "投票结果", Icon: "dvr",
